                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Madera en rollo</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">Madera acerrada</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Apartado 1</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">Apartado 2</a>
                                </nav>
                            </div>
